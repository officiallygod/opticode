...
import { NumberOutlined, SettingOutlined, SettingFilled } from "@ant-design/icons";
import "./Header.css";
    ...
    return (
        <>
            <div
                ...
                <div
                    className="header-right-sm">
                    <div
                        className="header-nav modal-icon">
                        <SettingOutlined
